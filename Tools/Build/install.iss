...
#define private ApplicationVersion "1.58"
...
Source: {#SourcePath}BouncyCastle.Crypto.dll; DestDir: "{app}"
Source: {#SourcePath}Google.Protobuf.dll; DestDir: "{app}"
Source: {#SourcePath}MySql.Data.dll; DestDir: "{app}"
Source: {#SourcePath}Renci.SshNet.dll; DestDir: "{app}"
